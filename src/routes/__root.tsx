...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "web3brasillinks — encurtador com analytics de grupos" },
      { name: "description", content: "Encurtador de links com analytics de cliques e rastreamento de entradas em grupos de Telegram, Discord, WhatsApp, X e Instagram." },
      { property: "og:title", content: "web3brasillinks — encurtador com analytics de grupos" },
      { property: "og:description", content: "Encurtador de links com analytics de cliques e rastreamento de entradas em grupos de Telegram, Discord, WhatsApp, X e Instagram." },
